...
let website = "/ReproCsv"

let githubLink = "https://github.com/Update GitHome in build.fsx/ReproCsv"

// Specify more information about your project
let info =
  [ "project-name", "ReproCsv"
    "project-author", "Robin Munn"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ReproCsv" ]
